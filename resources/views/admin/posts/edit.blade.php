					...
					<select name="category_id" id="category" class="form-control">
						@foreach($categories as $category)
							<option value="{{$category->id}}" 
								{{-- this is one to many relationship so dont need to looping  --}}
								@if($edit_data->category_id == $category->id)
									selected 
								@endif
								>
								{{$category->name}}
					...
					<div class="form-group">
						...
						<div class="check-box">
							<label>
								...
								{{-- this is mnay to many relationship so  need to looping  --}}
